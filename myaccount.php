...
$query = "SELECT * FROM Order_Report where id='".$id."'";
           ...
           <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>My account</div>
            ...
            <p class="details">
             Login your account.
                ...
                <div class="form_subtitle">login into your account</div>
                 <form name="login" action="checklogin.php" method="post">          
					...
					if($result=="false")	
					{			 
				    echo"<font color=#FF0000>Incorrect username</font>";
					}
					echo'
                    </div> 
				...
				';}
              	...
              	<div class="contact_form">
                <div class="form_subtitle">Your account</div>';
             ...
             <p><font size="+1">Address:  
				...
				$pNAME = OCIResult($stmt,"PRODUCT_NAME");
				$oID = OCIResult($stmt,"ORDER_ID");
				$PRICE = OCIResult($stmt,"PRICE");
				echo '<div class="form_row"><table border="2"><tr>
				<td>ID</td>
				<td>Product Code</td>
				<td>Quantity</td>
				<td>Price</td>
