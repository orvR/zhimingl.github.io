...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
        	<div class="crumb_nav">
            <a href="index.html">home</a> &gt;&gt;<a href="details.html">Ribbit pet food</a></div>
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span><a href="p5.php">Ribbit pet food</a></div>
        
        	<div class="feat_prod_box_details">
            
            	<div class="prod_img"><a href="p5.php"><img src="images/thumb3.gif" alt="" title="" border="0" /></a>
                <br /><br />
                ...
                <div class="prod_det_box">
                    ...
                    <p class="details">CopRice Complete All Natural Rabbit &amp; Guinea Pig Pellets is a scientifically formulated and nutritionally balanced complete pelleted feed that is designed specifically for rabbits and guinea pigs.</p>
                    ...
                    <tr>
                    <td>
                    <a href="cart.php?action=add&id=05" class="checkout">add to cart</a>
                    </td>
                    <td>
                    <a href="order.php?action=add&id=05" class="checkout">Order </a>
                    </td>
                    </tr>
                    </table>
                    <div class="clear"></div>
            ...
            <div class="tabs-container">
                    ...
                    <div style="display: block;" class="tab" id="tab1">
                                        <p class="more_details">It is based on rice and rice bran for high digestibility and contains a high level of good quality fibre for optimum digestive function.</p>                           
                    </div>	
