...
<div id="wrap">
       ...
       <div class="center_content">
       	<div class="left_content">
        	<div class="crumb_nav">
            <a href="index.html">home</a> &gt;&gt;<a href="details.html">Parson Jack Russe</a></div>
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span><a href="p3.php">Parson Jack Russe</a></div>
        
        	<div class="feat_prod_box_details">
            
            	<div class="prod_img"><a href="p3.php"><img src="images/thumb1.gif" alt="" title="" border="0" /></a>
                <br /><br />
                ...
                <div class="prod_det_box">
                    ...
                    <p class="details">The Parson is a relatively small active and lively mainly white coloured terrier. As they were originally used with foxhounds to go to ground after foxes they are built accordingly. They have long legs, which were ideal for keeping up with the horses; but their body is shaped to allow them to be able to get into small spaces.</p>
                    ...
                    <tr>
                    <td>
                    <a href="cart.php?action=add&id=03" class="checkout">add to cart</a>
                    </td>
                    <td>
                    <a href="order.php?action=add&id=03" class="checkout">Order </a>
                    </td>
                    </tr>
                    </table>
                    <div class="clear"></div>
            ...
            <div class="tabs-container">
                    ...
                    <div style="display: block;" class="tab" id="tab1">
                                        <p class="more_details"> The Parson Jack Russell was developed and established in the 18th Century in Devon by the Reverend John Russell. John Russell was born into a fox hunting family in 1795, where his love of hunting was nurtured. He wanted a dog that could keep up with the horses, run with the foxhounds and was small enough to flush the foxes from their dens. While studying at Oxford he saw, and bought, the perfect dog for his purposes, belonging to the milkman. It is thought that this was this was the first dog to be known as a Jack Russell. During his time as a clergyman, John Russell devoted himself to both the church and breeding terriers suitable for fox hunting.</p>                           
                    </div>	
